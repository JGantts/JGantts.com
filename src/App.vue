...
@font-face {
  ...
  src:
    local("Figtree"),
    url(./assets/fontsFigtree/Figtree-Regular.woff2),
    format("woff2");
}
@font-face {
  font-family: "Figtree";
  ...
  src:
    local("Figtree"),
    url(./assets/fontsFigtree/Figtree-Medium.woff2),
    format("woff2");
}
@font-face {
  font-family: "Figtree";
  ...
  src:
    local("Figtree"),
    url(./assets/fontsFigtree/Figtree-Bold.woff2),
    format("woff2");
}
@font-face {
  font-family: "Figtree";
  ...
  src:
    local("Figtree"),
    url(./assets/fontsFigtree/Figtree-ExtraBold.woff2),
    format("woff2");
}
@font-face {
  font-family: "Figtree";
  ...
  src:
    local("Figtree"),
    url(./assets/fontsFigtree/Figtree-Black.woff2),
    format("woff2");
}
